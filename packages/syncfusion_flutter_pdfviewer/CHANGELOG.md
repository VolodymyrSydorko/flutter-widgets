...
* Now, the page remains locked in view when zoomed in, preventing unexpected navigation to a previous page when scrolling to the top or left edge in single layout mode.
